            ...
            <form onSubmit={handleCreateAdmin} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  id="name"
                  required
                  className="block  text-black placeholder-gray-500 w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  value={newAdmin.name}
              ...
              <div>
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="block w-full  text-black placeholder-gray-500 px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
